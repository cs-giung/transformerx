...
PREDEFINED_CONFIGS = {
    ...
    'cs-giung/clip-vit-base-patch32-laion2b': CLIPTxTConfig(
        hidden_act='gelu',
        hidden_size=512,
        intermediate_size=2048,
        layer_norm_eps=1e-05,
    ...
    'cs-giung/clip-vit-base-patch16-laion2b': CLIPTxTConfig(
        hidden_act='gelu',
        hidden_size=512,
        intermediate_size=2048,
        layer_norm_eps=1e-05,
    ...
    'cs-giung/clip-vit-large-patch14-laion2b': CLIPTxTConfig(
        hidden_act='gelu',
        hidden_size=768,
        intermediate_size=3072,
        layer_norm_eps=1e-05,
    ...
    'cs-giung/clip-vit-huge-patch14-laion2b': CLIPTxTConfig(
        hidden_act='gelu',
        hidden_size=1024,
    ...
    'cs-giung/clip-vit-giant-patch14-laion2b': CLIPTxTConfig(
        hidden_act='gelu',
        hidden_size=1024,
        intermediate_size=4096,
        layer_norm_eps=1e-05,
    ...
    'cs-giung/clip-vit-gigantic-patch14-laion2b': CLIPTxTConfig(
        hidden_act='gelu',
        hidden_size=1280,
    ...
    'cs-giung/clip-vit-base-patch32-fullcc2.5b': CLIPTxTConfig(
        hidden_act='quick_gelu',
        hidden_size=512,
        intermediate_size=2048,
        layer_norm_eps=1e-05,
    ...
    'cs-giung/clip-vit-base-patch16-fullcc2.5b': CLIPTxTConfig(
        hidden_act='quick_gelu',
        hidden_size=512,
        intermediate_size=2048,
        layer_norm_eps=1e-05,
    ...
    'cs-giung/clip-vit-large-patch14-fullcc2.5b': CLIPTxTConfig(
        hidden_act='quick_gelu',
        hidden_size=768,
        intermediate_size=3072,
        layer_norm_eps=1e-05,
    ...
    'cs-giung/clip-vit-huge-patch14-fullcc2.5b': CLIPTxTConfig(
        hidden_act='quick_gelu',
        hidden_size=1024,
        intermediate_size=4096,
        layer_norm_eps=1e-05,
    ...
    'cs-giung/clip-vit-gigantic-patch14-fullcc2.5b': CLIPTxTConfig(
        hidden_act='quick_gelu',
        hidden_size=1280,
        intermediate_size=5120,
        layer_norm_eps=1e-05,
